...
$img_no_caption = "Hebron Adventures "; //default caption for image that don't have one

$page_title="Hebron Adventure"; //changes the <title> attribute AND the logo in top left corner
